// // frontend/src/features/admin/ManageStudents.tsx
...
//       const res = await axios.get<StudentsResponse | User[]>(
...
//       else if ("students" in res.data) data = res.data.students;
...
//     try {
//       const token = localStorage.getItem("token");
//       const res = await axios.post<AddStudentResponse>(
//         "http://localhost:5000/api/admin/users",
//         { name, email, password },
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
